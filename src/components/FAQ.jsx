...
const FAQ = () => {
  const faqs = [
    {
      id: 'One',
      question: '自分たちが見たいジャンル/媒体はある？',
      answer: '無い場合もあります。全てのジャンルや媒体のデータが十分な数あるとは限りませんので、ぜひ一度データの有無確認などについてもお問合せください。'
    },
    {
      id: 'Two',
      question: '契約期間はどのくらいですか？',
      answer: '契約期間に関しては、プランによって異なりますので詳細はお問合せください。縛りの無いプランなどもご用意しております。'
    }
  ];
